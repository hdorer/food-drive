...
public struct ItemData {
    ...
    public static ItemData[] ITEM_DATA_LIST = new ItemData[(int)ItemType.NUM_ITEMS] {
        new ItemData(1, ItemType.PURPLE_SQUARE),
        new ItemData(2, ItemType.ORANGE_CIRCLE),
        new ItemData(3, ItemType.GREEN_CAPSULE),
        new ItemData(4, ItemType.RED_CIRCLE),
        new ItemData(5, ItemType.ORANGE_SQUARE)
    };
}
